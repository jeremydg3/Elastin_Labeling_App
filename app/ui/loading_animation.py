...
from PyQt6.QtGui import (QPixmap, QPainter, QMovie, QKeyEvent, 
                         QShowEvent, QCloseEvent, QBrush)
from PyQt6.QtCore import Qt, QTimer
from PyQt6.QtWidgets import QDialog, QLabel, QWidget, QVBoxLayout
